...
class Viaje {
    ...
    public function __construct($codigo, $destino, $cant_max_pasajeros, $responsable) {
        $this->codigo = $codigo;
...
// Accede a los atributos y al arreglo de cadenas de los pasajeros para formar un string final con todos los datos pedidos.
    public function __toString() {
        return "Viaje a " . $this->getDestino() . " (Código: " . $this->getCodigo() . ") con pasajeros: " . $pasajeros(). "Responsable: " .$this->getResponsable();
    }
    
}

$pasajero= array();
$pasajeros[0] = new Pasajero("jorge", "carlos", "23123121", "99999111111");
$pasajeros[1] = new Pasajero("pepe", "sanchez", "23121", "99321111");
$responsable = new ResponsableV("1771", "XD", "alberto", "fernandez");
$viaje = new Viaje("11 ", "la luna", 4, $pasajeros(), $responsable);
echo $viaje;